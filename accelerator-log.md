...
```json
{
  "projectName" : "yelb-customer-profile-ui",
...
┃ ┃ ┃ ┃ ┃ ┗  Info Will replace [tanzu-java-web-app->yelb-customer-profil...(truncated)]
...
┃ ┃ ┃ ┃ ┃ ┗  Info Will replace [: tanzu-java-web-app->: yelb-customer-prof...(truncated)]
